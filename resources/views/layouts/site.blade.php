...
<html lang="fa" class="js">
    ...
    <body class="has-rtl nk-body bg-white npc-landing" dir="rtl">
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-sm-7 col-md-6 col-9">
                                <div class="section-head">
                                    <h2 class="title">ارائه خدمات مختلف</h2>
                                </div>
                                <!-- .section-head -->
                            </div>
                            <!-- .col -->
		...
		C466.5,10.8,466.4,10.7,466.4,10.5L466.4,10.5z"
                                        ...
                                        <div class="service-text">
                                            <h4 class="title">داشبورد پیشرفته</h4>
                                            <p>اما من باید برای شما توضیح دهم که چگونه این همه تصور اشتباه از لذت.</p>
                                        </div>
                                    </div>
                                    <!-- .service -->
                                </div>
		...
		C412.9,398.1,398.1,412.9,379.9,412.9z"
                                        ...
                                        <div class="service-text">
                                            <h4 class="title">مدیریت سرویس ها</h4>
                                            <p>آموزه های واقعی کاشف بزرگ حقیقت را توضیح دهید.</p>
                                        </div>
                                    </div>
                                    <!-- .service -->
                                </div>
				...
				c3.3,3.3,8.7,3.3,12.1,0l69.3-69.3C316.4,291.7,316.4,286.3,313.1,283z"
                                        ...
                                        <div class="service-text">
                                            <h4 class="title">به روز رسانی سرورها</h4>
                                            <p>ستایش درد زاده شد و حسابی کامل برایت می گذارم.</p>
                                        </div>
                                    </div>
                                    <!-- .service -->
                                </div>
                        ...
                        <div class="row flex-row-reverse align-items-center justify-content-between g-gs">
                            <div class="col-lg-5">
                                <div class="img-block img-block-s1 right">
                                    <img src="/assets/img/warp-desktop-3.png" alt="تصویر" />
                                </div>
                                <!-- .img-block -->
                            </div>
                            <!-- .col -->
                            <div class="col-lg-6">
                                <div class="text-block">
                                    <h2 class="title">برخی از امکانات منحصر به فرد</h2>
                                    <div class="g-gs">
	...
	c1.5-2,1.6-4.7,0.2-6.8c-4.1-6.5-7.1-13.6-8.8-21.1c-0.5-2.4-2.4-4.3-4.8-4.7l-18.7-3L167.3,247.1z"
                                            ...
                                            <div class="service-text">
                                                <h4 class="title">مدیریت آسان</h4>
                                                <p>انواع مختلفی از معابر لورم ایپسوم موجود است، اما اکثر آن ها دچار تغییر شدند.</p>
                                            </div>
                                        </div>
                                        <!-- .service -->
                                        <div class="service service-s3">
			...
			c0-0.2,0-0.4,0-0.7C218.6,111.9,211.5,105,202.8,105.2z"
                                            ...
                                            <div class="service-text">
                                                <h4 class="title">یک ویژگی کامل</h4>
                                                <p>تغییرات جزئی از معابر موجود اکثریت دچار تغییرات حتی اندکی قابل باور شدند.</p>
                                            </div>
                                        </div>
                                        <!-- .service -->
                                    </div>
                ...
                <section class="section section-feature">
                    <div class="container">
                        <div class="row align-items-center justify-content-between g-gs">
                            ...
                            <div class="col-lg-6">
                                <div class="text-block">
                                    <h2 class="title">دارای سرورهای متعدد</h2>
                                    <p class="lead">اما اکثریت دچار تغییراتی به شکلی شدند، از طریق شوخ طبعی تزریقی، یا تصادفی کمی باورپذیر.</p>
                                    <p>
                                        ...
                                        <div class="review review-s2">
                                            ...
                                            <div class="review-content">
                                                ...
                                                <div class="review-text">
                                                    <p>این یک واقعیت ثابت شده است که خواننده هنگام مشاهده طرح بندی با محتوای قابل خواندن آن حواسش پرت می شود.</p>
                                                    <h6 class="review-name text-dark">امیر بزرگی</h6>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- .review -->
        ...
        <div class="finalize-box" id="finalize-box">
            <a href="#" onclick="submitOrder()">نهایی کردن خرید</a>
            <div>
                ...
                if (cartKeys.length > 0) {
                    ...
                    cartBottom.innerHTML = 
                        `<div style="width: 100%; display: flex;">
                            <a style="flex: 1;" href="#" onclick="submitOrder()">نهایی کردن خرید</a>
